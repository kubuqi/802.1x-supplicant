...
#include <string.h>
	...
	type_md5(ui8 const *_secret, size_t _len, ui8 const *_identity, size_t _ilen);	// zl changed from : type_md5(ui8 const *_secret, size_t _len);
	...
	class identity_buffer: public buffer	// zl added
	{
	public:
		identity_buffer(ui8 const * _identity, size_t len) : buffer(len), _len(len)
		{
			memcpy(buf, _identity, len);
		}
	...
	identity_buffer	id_buf;		// zl added identity buffer
    };
}
