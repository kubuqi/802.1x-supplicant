 ...
 *
 * $Log: radproto.h,v $
 * Revision 1.5  2004/08/10 02:32:03  zhanglu
 * GnuGK:New faster Radius implementation, thanks to Pavel Pavlov for ideas!
 *
...
#ifndef __RADPROTO_H
#define __RADPROTO_H "@(#) $Id: radproto.h,v 1.5 2004/08/10 02:32:03 zhanglu Exp $"
...
public:
	...
	enum AttrTypes {
		...
		PasswordRetry = 75, 
		Prompt = 76, ConnectInfo, ConfigurationToken, EapMessage, MessageAuthenticator,	// zl added EapMessage and Message-Authenticator
...
public:
	...
	enum Constants {
		...
		///zl added : Length of Message-Authenticator vector inside Fixed Header
	...
	*/
	...
	//{{ zl added
	/** Calculate the whole packet and fill the hash value into 
		Message-Authenticator field.
	*/
	void SetupMessageAuthenticator( 
		const PString& secret /// secret shared between client and server
		);
	//}} zl added
