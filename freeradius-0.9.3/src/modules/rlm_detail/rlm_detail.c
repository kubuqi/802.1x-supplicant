 ...
 *
 * Version:	$Id: rlm_detail.c,v 1.30.2.1 2003/09/12 19:18:04 phampson Exp $
 *
...
static const char rcsid[] = "$Id: rlm_detail.c,v 1.30.2.1 2003/09/12 19:18:04 phampson Exp $";
