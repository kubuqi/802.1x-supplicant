 ...
 *
 * Version:	$Id: rlm_sql.c,v 1.116.2.3 2003/09/28 13:21:09 phampson Exp $
 *
...
static const char rcsid[] =
	"$Id: rlm_sql.c,v 1.116.2.3 2003/09/28 13:21:09 phampson Exp $";
...
static CONF_PARSER module_config[] = {
	...
	{"authorize_check_ip_query", PW_TYPE_STRING_PTR,			/* zl added */
	 offsetof(SQL_CONFIG,authorize_check_ip_query), NULL, ""},	/* zl added */
...
static int rlm_sql_authorize(void *instance, REQUEST * request)
{
	...
	/* zl added begin */
	radius_xlat(querystr, sizeof(querystr), inst->config->authorize_check_ip_query, request, sql_escape_func);
