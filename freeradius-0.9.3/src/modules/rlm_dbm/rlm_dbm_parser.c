 ...
 *
 * Version:     $Id: rlm_dbm_parser.c,v 1.7.2.1 2003/09/12 19:18:04 phampson Exp $
 *
...
char sccsid[] =
"$Id: rlm_dbm_parser.c,v 1.7.2.1 2003/09/12 19:18:04 phampson Exp $ sandy module project\n Copyright 2001 Sandy Service\nCopyright 2001 Koulik Andrei";
	...
	while ((ch = getopt(n, argv, "d:i:xo:qvc")) != -1) 
	 	switch (ch) {
			...
			case 'q':
				...
				break;
			case 'v':
				printf("%s: $Id: rlm_dbm_parser.c,v 1.7.2.1 2003/09/12 19:18:04 phampson Exp $ \n",progname);
				exit(0);
			case 'c':
