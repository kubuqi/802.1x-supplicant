 ...
 * rlm_attr_rewrite.c
 *
 * Version:  $Id: rlm_attr_rewrite.c,v 1.11.2.1 2003/07/14 17:29:28 aland Exp $
 *
...
static const char rcsid[] = "$Id: rlm_attr_rewrite.c,v 1.11.2.1 2003/07/14 17:29:28 aland Exp $";
