 ...
 * rlm_sqlcounter.c
 *
 * Version:  $Id: rlm_sqlcounter.c,v 1.8.2.1 2003/07/14 17:29:31 aland Exp $
 *
...
static const char rcsid[] = "$Id: rlm_sqlcounter.c,v 1.8.2.1 2003/07/14 17:29:31 aland Exp $";
